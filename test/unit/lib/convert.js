...
var convert = require('../../../src/lib/convert.js');
...
describe('rgbToHex', function() {
  ...
  it('validate.validateHex(convert.rgbToHex(random.randRgb())) should be true ', function(){
...
describe.skip('RGB to Accent', function() {
...
describe.skip('RGB to Gray', function() {
...
describe('RGB to Tone', function() {
  ...
  it('validate.validateRgb(convert.rgbToTone("rgb(255,255,255)", "rgb(0,0,0)")) should be true', function(){
