...
describe('Validate RGB', function() {
  it('validate.rgb(rgb(0,0,0)) should be true', function(){
  	expect(validate.rgb("rgb(0,0,0)")).to.be.true;
  });
  it('validate.rgb(rgb(20 , 20, 20)) should be true', function(){
  	expect(validate.rgb("rgb(20 , 20, 20)")).to.be.true;
  });
  it('validate.rgb(rgb( 40, 30, 230)) should be true', function(){
  	expect(validate.rgb("rgb( 40, 30, 230)")).to.be.true;
  });
  it('validate.rgb(rgb(f,3,3)) should be false', function(){
